...
public class Sign {
	...
	private static final String[] TIPS = {
		...
		"Levelling up is important!\n\nBeing about the same level as the floor you are on is a good idea. " +
				...
				"\n\nIf you got enough food, you can rest to regenerate some health. Low traffic areas are good for naps.",
		...
		"Fumbles isn't the only character that benefits from being a bit sneaky. You can retreat to the other side of a " +
		...
		"Being hungry doesn't hurt, but starving does.",
		...
		"This tract holds quite possibly the worst monster the city of Brassmoon ever saw.",
	...
	private static final String TXT_BURN =
		"As you try to read the sign it bursts into greenish flames." +
            "\n\n Was that a lidless eye in there? ";
