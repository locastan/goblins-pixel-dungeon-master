...
public class Dungeon {
	...
	public static int difficultyLevel = GoblinsPixelDungeon.getDifficulty();
	...
	public static void init() {
		difficultyLevel = GoblinsPixelDungeon.getDifficulty();

		version = Game.versionCode;
		challenges = GoblinsPixelDungeon.challenges();
	...
	private static final String RG_GAME_FILE	= "fumbles.dat";
	private static final String RG_DEPTH_FILE	= "fumbles%d.dat";
	
	private static final String WR_GAME_FILE	= "complains.dat";
	private static final String WR_DEPTH_FILE	= "complains%d.dat";
	
	private static final String MG_GAME_FILE	= "chief.dat";
	private static final String MG_DEPTH_FILE	= "chief%d.dat";
	
	private static final String RN_GAME_FILE	= "thaco.dat";
	private static final String RN_DEPTH_FILE	= "thaco%d.dat";
	...
	public static void loadGame( String fileName, boolean fullLoad ) throws IOException {
		try {
			...
			GoblinsPixelDungeon.setDifficulty(Dungeon.difficultyLevel );
